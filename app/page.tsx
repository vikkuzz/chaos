      ...
      <Section id="kak-igrat" title="Как играть">
        <div className="space-y-6 text-slate-300">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <strong className="text-slate-200">Выбор игрока:</strong> кнопки в
              панели управления (локальная игра)
            </li>
            <li>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div className="rounded-lg border border-slate-600 bg-slate-800/80 p-6">
            ...
            <p className="text-slate-400 text-sm sm:text-base mb-4">
              Симуляция на одном устройстве. Управляйте всеми игроками или
              наблюдайте за автономной битвой.
            </p>
            <Link
              href="/game"
